  ...
  <div id="homepage" class="fullwidth-container">
    ...
    <section class="inverted">
      <div class="section-container">
        ...
        <p>
          Noiiice is an open source blog platform built with the serverless framework, NuxtJS, AWS Lambda, DynamoDB, API Gateway, S3, and Cogntio.
        </p>
        <p>
          Ready to give it a try?
        </p>
        <p class="centered addtopmargin">
          <router-link class="button" to="/post/install">
            get started
          </router-link>
        </p>
      </div>
